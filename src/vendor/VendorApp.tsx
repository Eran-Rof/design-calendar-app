...
import ShipmentSubmit from "./shipments/ShipmentSubmit";
import InvoicesList from "./invoices/InvoicesList";
import InvoiceSubmit from "./invoices/InvoiceSubmit";
...
import POMessages from "./po/POMessages";
import VendorScorecard from "./analytics/VendorScorecard";
import VendorReports from "./analytics/VendorReports";
import VendorPODetail from "./po/VendorPODetail";
import POPrintView from "./po/POPrintView";
import VendorPhasesView from "./po/VendorPhasesView";
import VendorContracts from "./contracts/VendorContracts";
import VendorContractDetail from "./contracts/VendorContractDetail";
import VendorDisputes from "./disputes/VendorDisputes";
import VendorDisputeDetail from "./disputes/VendorDisputeDetail";
import VendorCatalog from "./marketplace/VendorCatalog";
import VendorBulk from "./bulk/VendorBulk";
import VendorApiKeys from "./auth/VendorApiKeys";
import VendorOnboarding from "./auth/VendorOnboarding";
import VendorEdi from "./integrations/VendorEdi";
import VendorErp from "./integrations/VendorErp";
import VendorHealth from "./analytics/VendorHealth";
import VendorRfqs from "./rfqs/VendorRfqs";
import VendorRfqDetail from "./rfqs/VendorRfqDetail";
import VendorEntitySwitcher from "./VendorEntitySwitcher";
import VendorMobileFeed from "./mobile/VendorMobileFeed";
import PortalLogin from "./auth/PortalLogin";
import VendorWorkspaces from "./workspaces/VendorWorkspaces";
import VendorSustainability from "./esg/VendorSustainability";
import VendorDiversity from "./esg/VendorDiversity";
import VendorMarketplace from "./marketplace/VendorMarketplace";
import VendorEsg from "./esg/VendorEsg";
import VendorDiscountOffers from "./payments/VendorDiscountOffers";
import VendorPaymentPreferences from "./payments/VendorPaymentPreferences";
import VendorScf from "./payments/VendorScf";
