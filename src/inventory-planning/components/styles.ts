...
// ── Date formatting ────────────────────────────────────────────────────────
// House format is DD/MM/YYYY (e.g. 19/04/2026) everywhere planning data
// is shown. ISO strings are parsed as UTC to keep month boundaries stable.

// "2026-04-19" or "2026-04-19T12:34:56Z" → "19/04/2026". Returns "–" on null/invalid.
...
// Timestamp with local time for audit trails. Returns e.g. "19/04/2026 14:32".
