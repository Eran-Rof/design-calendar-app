...
const TANDA_MENU: MenuKey[] = [
  ...
  { key: "tanda/accounting/ar-collections", label: "Collections",   app: "tanda", route: "/tangerine?m=ar_collections",    group: "Customers – Accts Rec", icon: "📞" },
  ...
  { key: "tanda/accounting/consolidation", label: "Consolidation",  app: "tanda", route: "/tangerine?m=consolidation",     group: "Accounting", icon: "🏛️" },
  ...
  { key: "tanda/today",                label: "Today",               app: "tanda", route: "/tangerine?m=today",            group: "Today", icon: "🌅" },
  ...
  { key: "tanda/admin/cutover-recon",        label: "Cutover Reconciliation", app: "tanda", route: "/tangerine?m=cutover_recon",  group: "Admin", icon: "🧮" },
];
