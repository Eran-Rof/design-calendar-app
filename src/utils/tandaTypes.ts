...
export type View = "dashboard" | "list" | "detail" | "grid" | "templates" | "email" | "teams" | "activity" | "vendors" | "timeline" | "archive" | "shipments" | "match" | "compliance" | "messages" | "scorecards" | "spend" | "onboarding" | "anomalies" | "analytics" | "health_scores" | "preferred_vendors" | "rfqs" | "workflow_rules" | "workflow_executions" | "entities" | "style_master" | "vendor_master" | "customer_master" | "gl_accounts" | "gl_periods" | "journal_entries" | "insights" | "workspaces" | "sustainability" | "esg_scores" | "diversity" | "compliance_automation" | "compliance_audit" | "marketplace" | "marketplace_inquiries" | "benchmark" | "discount_offers" | "payments" | "scf" | "fx" | "virtual_cards" | "tax" | "phase_reviews" | "notifications";
...
export const DEFAULT_WIP_TEMPLATES: WipTemplate[] = [
  ...
  { id: "wip_topsample", phase: "Top Sample",                category: "Samples",        daysBeforeDDP: 18,  status: "Not Started", notes: "" },
