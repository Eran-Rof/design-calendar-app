// Shared "← PLM" navigation for the whole suite.
//
...
//
// This lives in the shared NavDrawer footer (every app except ATS renders it),
// so apps get correct back-to-PLM for free. ATS (no drawer) re-exports it from
// src/ats/backToPlm.ts.
