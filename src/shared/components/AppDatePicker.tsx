// Shared date picker — the single calendar widget every app uses.
// Custom popover (no native <input type="date">) so styling stays
// consistent across browsers + apps. Slate-800 surface, emerald
// "Today" link, blue selection.
//
// API: `{ value: ISO yyyy-mm-dd, onCommit, style }`. onCommit gets
// "" when the user clicks Clear.
//
// History: originally lived at src/tanda/detail/MilestoneDateInput.tsx;
// moved here on 2026-05-21 so shared/ is canonical. Tanda still imports
// MilestoneDateInput from its old path — that file is now a re-export
// of this AppDatePicker, so no consumer change is required.
...
export const AppDatePicker: React.FC<AppDatePickerProps> = ({ value, onCommit, style }) => {
