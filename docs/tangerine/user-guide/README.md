...
33. [Inventory Planning → Tangerine POs (M31 / P17)](33-inventory-planning-to-tangerine-po.md) — turn an approved planning **buy plan** into draft native Tangerine purchase orders (one per vendor): Preview (dry-run), cost fallback, coded skip reasons, one-click vendor linking, and the persistent action→PO deep-link.
