...
| **By-size residual: 20 styles not cut over** | Small tail from the 2026-07-01 batch | **8 non-sized** styles (blank REST Size — accessories/samples: BP00001, FL0000x, HS00001, JK00001, ML00001; + PTYT0023C & RBO0107N which have SOME blank-size cells) are skipped — they need a size scale / proper SKUs. **12 sized-BP / SKU-less style rows** (RYB059432 = style RYB0594 + waist 32, RYB086932/34(PL), RYB109432/34(PL), RYB004334, RYB020032, RYB087932, RYB097332) have **zero SKUs of their own** — their stock belongs to the parent style's size axis. The batch now **skips** them (a guard refuses to write layers onto a foreign SKU; an earlier run's orphan double-count was found + removed, backup `.launchd-logs/orphan-onhand-DELETED-2026-07-01.json`). Fix = map each sized-BP to its parent style's size (or give it real SKUs); ~7.9k units, low priority. |
