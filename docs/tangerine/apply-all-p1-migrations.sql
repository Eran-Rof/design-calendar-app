-- Tangerine P1 bundled migration (T1-fix-8)
-- Customers gets entity_id defensively (Chunk 1's propagation
-- may have failed for ip_customer_master; this guards against that).
