// api/vendor/workspaces/:id/pins
//
// POST — vendor-created pin.

import { createClient } from "@supabase/supabase-js";
import { authenticateVendor } from "../../../../../_lib/vendor-auth.js";
import { authorizeVendorAccess, validatePinInput, resolvePin } from "../../../../../_lib/workspaces.js";
...
export default async function handler(req, res) {
  ...
  const { data, error } = await admin.from("workspace_pins").insert({
    ...
    pinned_by_type: "vendor",
    pinned_by: authRes.auth.vendor_user_id || authRes.auth.vendor_id,
