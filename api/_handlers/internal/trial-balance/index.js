...
// P10-8 D9: every report shows the **current entity only**. The Entity
// Switcher (P10-5) attaches X-Entity-ID on every internal call. If absent
// (legacy bookmark, server-side smoke), fall back to ROF.
